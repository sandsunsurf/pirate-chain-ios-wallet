    ...
    func getRandomizedPadDigits()->[NumPadRow]{
        ...
        for aNumber in uniqueNumbers {
            ...
            if uniqueNumbers.last == aNumber {
                ...
                arrayOfNumPadValues.append(NumPadValue(id: 1, value: aNumber.numberString))
            }else{
                arrayOfNumPadValues.append(NumPadValue(id: aColumnIndex, value: aNumber.numberString))
            }
